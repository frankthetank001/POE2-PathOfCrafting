...
from app.schemas.crafting import CraftableItem, ItemModifier, ItemRarity, ModType, EssenceInfo, EssenceItemEffect
...
class DataDrivenEssence(CraftingCurrency):
    """Data-driven essence implementation using database storage."""
    ...
    def can_apply(self, item: CraftableItem) -> Tuple[bool, Optional[str]]:
        ...
        if self.essence_info.mechanic == "magic_to_rare":
            ...
            # Perfect/Corrupted essences: work on any rarity but need existing mods to remove
            if item.rarity == ItemRarity.NORMAL:
                pass  # Can apply to normal items
    ...
    def _item_matches_effect_type(self, item: CraftableItem, effect_item_type: str) -> bool:
        ...
        category_mapping = {
            ...
            "Sceptre": ["Sceptre"],
            "Quiver": ["Quiver"],
            # New categories for different armour types
...
# REMOVED: Legacy BaseEssence implementation - replaced with DataDrivenEssence
